...
int023([Input Storage], 7168771, 240);
Set(Icon(a), 
...
DisableIconRotation(false);
SetProductCode([]);
SetExprAtt(1, [Max(0, Normal(180, 60))]);
SetExprAtt(2, [{.~1|~1~.}1]);
SetExprAtt(3, [1]);
SetAtt(4, 1);
SetAtt(5, 1);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Quality 1], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\Atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([\Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
CreateAtom(a, Up(s), [], 1, false);
int023([Output Storage], 7168771, 240);
Set(Icon(a), 
...
{Atom: Copy of Quality2}

sets;
AtomByName([Server], Main);
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Copy of Quality2], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\Atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([\Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Copy of Man2], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\Atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([\Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
{Atom: Copy of Quality2 (1)}

sets;
AtomByName([Server], Main);
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Copy of Quality2 (1)], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\Atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([\Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
int018;
Up;
int014(1, 1230815, 1, 1230816, 0);
int014(0, 1230829, 1, 1230815, 0);
int014(1, 1230816, 1, 1230817, 0);
int014(1, 1230817, 1, 1230818, 0);
int014(1, 1230818, 1, 1230819, 0);
int014(1, 1230819, 1, 1230820, 0);
int014(1, 1230820, 1, 1230822, 0);
int014(2, 1230820, 1, 1230823, 0);
int014(3, 1230820, 1, 1318225, 0);
int014(1, 1230822, 1, 1230824, 0);
int014(1, 1230823, 2, 1230824, 0);
int014(1, 1230824, 1, 1230826, 0);
int014(2, 1230824, 1, 1230827, 0);
int014(3, 1230824, 1, 1279366, 0);
int014(1, 1318225, 3, 1230824, 0);
int014(4, 1230824, 1, 1378805, 0);
int014(1, 1230826, 2, 1230828, 0);
int014(1, 1230827, 1, 1230828, 0);
int014(1, 1279366, 3, 1230828, 0);
int014(1, 1378805, 4, 1230828, 0);
int006(10, 1230815, 1, 0, 0);
