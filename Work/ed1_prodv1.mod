...
int014(0, 126, 1, 114, 0);
int014(1, 116, 1, 117, 0);
int014(1, 117, 1, 118, 0);
int014(1, 118, 1, 119, 0);
int014(1, 119, 1, 120, 0);
int014(2, 119, 1, 121, 0);
int014(1, 120, 2, 122, 0);
int014(1, 121, 1, 122, 0);
int014(1, 122, 1, 123, 0);
int014(2, 122, 1, 124, 0);
int014(1, 123, 2, 125, 0);
int014(1, 124, 1, 125, 0);
int006(10, 114, 1, 0, 0);
