...
int013(1, 0, true, false, 0, 0, [], []);
int013(2, 0, true, false, 0, 0, [], []);
SetLoc(31.4088706623819, 4.90147844373032, 0);
SetSize(3, 2, 1);
Set(RotationAs, -170.537677791974);
LockPosition(false);
LockSize(false);
DisableIconRotation(false);
SetProductCode([]);
...
int018;
Up;
int014(1, 114, 1, 115, 0);
int014(0, 120, 1, 114, 0);
int014(1, 115, 1, 116, 0);
int014(1, 116, 1, 117, 0);
int014(1, 117, 1, 2653585, 0);
int014(1, 118, 1, 119, 0);
int014(1, 2653585, 1, 118, 0);
int014(1, 2407020, 2, 119, 0);
int014(2, 2653585, 1, 2407020, 0);
int006(10, 114, 1, 0, 0);
