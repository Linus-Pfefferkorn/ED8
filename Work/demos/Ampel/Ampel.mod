...
int011;
int035([Table], pDir([Atoms\DATA\Table.atm]));
...
int035([Accumulating Conveyor], pDir([Atoms\TRANSPORT\CONVEYORS\ACCUMULATING\Accumulating Conveyor.atm]));
int012;


{Preregister functions}

PreregisterFunction([ZS], 2, 2);
PreregisterFunction([SetZS], 3, 3);
...
Set(OnInit, [Dim([refZS], vbAtom, c)]);
int023([ZS], 32896, 32);
DefineFunction([ZS], [Basic], 2, 2, [cell(p(1),p(2), refZS)], [Returns the value of cell(e1, e2)], [No example], 1, [Table.atm]);
DefineFunction([SetZS], [Basic], 3, 3, [setcell(p(1),p(2),p(3), refZS)], [Sets cell(e1, e2) to value e3], [No example], 1, [Table.atm]);
Set(Icon(a), 
...
CreateAtom(a, Up(s), [], 1, false);
int023([Ampel Stau], 12615680, 240);
Set(Icon(a), 
...
{Atom: Ampelschlange 1}

sets;
AtomByName([Queue], Main);
if(not(AtomExists), Error([Cannot find mother atom 'Queue'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Ampelschlange 1], 12615680, 240);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\queue.bmp]), [queue]));
SetMaterial(
	RegisterMaterial([Default], 8421504, 8421504, 3289650, 0, 0.100000001490116, 0, false, false, 1, 0), 1, a);
...
{Atom: Copy of Ampelschlange 1}

sets;
AtomByName([Queue], Main);
if(not(AtomExists), Error([Cannot find mother atom 'Queue'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Copy of Ampelschlange 1], 12615680, 240);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\queue.bmp]), [queue]));
SetMaterial(
	RegisterMaterial([Default], 8421504, 8421504, 3289650, 0, 0.100000001490116, 0, false, false, 1, 0), 1, a);
...
CreateAtom(a, Up(s), [], 1, false);
int023([Budapesterstr.], 7168771, 240);
Set(Icon(a), 
...
BaseClass;
CreateAtom(a, Up(s), [], 1, false);
int023([Fußgängersüd], 12615680, 73809);
Set(Icon(a), 
...
BaseClass;
CreateAtom(a, Up(s), [], 1, false);
int023([Autos], 12615680, 73809);
Set(Icon(a), 
	RegisterIcon(ModDir([auto.png]), [auto.png], 1, 0, 0, 255, 255, false, 0));
AddModel3D(
	RegisterModel3D(Model3DDir([box-closed.wrl]), [box-closed.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
AddModel3D(
	RegisterModel3D(Model3DDir([box-opened.wrl]), [box-opened.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
CreateAtom(a, Up(s), [], 1, false);
int023([Accumulating Conveyor16], 8421504, 1266);
Set(Icon(a), 
...
{Atom: Accumulating Conveyor18}

sets;
AtomByName([Accumulating Conveyor], Main);
if(not(AtomExists), Error([Cannot find mother atom 'Accumulating Conveyor'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Accumulating Conveyor18], 12632256, 1266);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\conveyor.bmp]), [conveyor]));
SetMaterial(
	RegisterMaterial([Default], 8421504, 8421504, 3289650, 0, 0.100000001490116, 0, false, false, 1, 0), 1, a);
...
{Atom: Copy of Accumulating Conveyor18}

sets;
AtomByName([Accumulating Conveyor], Main);
if(not(AtomExists), Error([Cannot find mother atom 'Accumulating Conveyor'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Copy of Accumulating Conveyor18], 12632256, 1266);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\conveyor.bmp]), [conveyor]));
SetMaterial(
	RegisterMaterial([Default], 8421504, 8421504, 3289650, 0, 0.100000001490116, 0, false, false, 1, 0), 1, a);
...
CreateAtom(a, Up(s), [], 1, false);
int023([Ampel Autos], 292315, 263408);
Set(Icon(a), 
...
SetProductCode([]);
SetExprAtt(1, [1]);
SetExprAtt(2, [{.~1|~if(And( (mod(time,ZS(1,5))>ZS(1,3)), (mod(time,ZS(1,5))<ZS(1,4)) ), 1,2)~.}if(And( (mod(time,ZS(1,5))>ZS(1,3)), (mod(time,ZS(1,5))<ZS(1,4)) ), 1,2)]);
SetExprAtt(3, [1]);
SetAtt(4, 2);
SetAtt(5, 1);
SetAtt(6, 1);
...
if(not(AtomExists), Error([Cannot find mother atom 'ArrivalList'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([Haltestelle], 7168771, 1256);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\atoms\source.bmp]), [source]));
SetMaterial(
	RegisterMaterial([Default], 8421504, 8421504, 3289650, 0, 0.100000001490116, 0, false, false, 1, 0), 1, a);
...
BaseClass;
CreateAtom(a, Up(s), [], 1, false);
int023([Fußgängernord], 12615680, 73809);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\Atoms\operatorblue.bmp]), [operatorblue]));
AddModel3D(
	RegisterModel3D(Model3DDir([box-closed.wrl]), [box-closed.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([AutosZurück], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([FGuntenZurück], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([FGAmpelSüd], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
SetProductCode([]);
SetExprAtt(1, [0]);
SetExprAtt(2, [{.~1|~if(And( (mod(time,ZS(1,5))>ZS(1,1)), (mod(time,ZS(1,5))<ZS(1,2)) ), 1,2)  ~.}if(And( (mod(time,ZS(1,5))>ZS(1,1)), (mod(time,ZS(1,5))<ZS(1,2)) ), 1,2)  ]);
SetExprAtt(3, [1]);
SetAtt(4, 2);
SetAtt(5, 1);
SetAtt(6, 1);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([FGobenZurück], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
if(not(AtomExists), Error([Cannot find mother atom 'Server'. Inheriting from BaseClass.]));
CreateAtom(a, Up(s), [], 1, false);
int023([FGAmpelNord], 292315, 263408);
Set(Icon(a), 
	RegisterIcon(IconsDir([bmp\atoms\server.bmp]), [server]));
AddModel3D(
	RegisterModel3D(Model3DDir([Server.wrl]), [Server.wrl], 0, 0, 0, 1, 1, -1, -90, 0, 0), a);
...
int018;
Up;
int014(1, 174, 1, 178, 0);
int014(0, 191, 1, 174, 0);
int014(1, 175, 1, 176, 0);
int014(0, 183, 1, 175, 0);
int014(1, 176, 1, 188, 0);
int014(1, 193, 2, 176, 0);
int014(1, 177, 1, 1783, 0);
int014(1, 187, 1, 177, 0);
int014(1, 190, 2, 177, 0);
int014(1, 1098, 3, 177, 0);
int014(1, 178, 1, 1786, 0);
int014(1, 1784, 2, 178, 0);
int014(1, 184, 1, 179, 0);
int014(1, 185, 1, 180, 0);
int014(1, 186, 1, 181, 0);
int014(1, 188, 1, 184, 0);
int014(1, 1786, 1, 185, 0);
int014(1, 1783, 1, 186, 0);
int014(0, 182, 1, 187, 0);
int014(2, 188, 1, 193, 0);
int014(0, 182, 1, 190, 0);
int014(2, 1783, 1, 1098, 0);
int014(2, 1786, 1, 1784, 0);
int006(0, 174, 1, 0, 0);
int006(0, 175, 1, 0, 0);
int006(0, 187, 1, 0, 0);
int006(60, 187, 2, 0, 0);
int006(0, 190, 1, 0, 0);
int006(100, 190, 2, 0, 0);
