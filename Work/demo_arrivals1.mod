...
int035([ArrivalList], pDir([Atoms\ArrivalList.atm]));
int012;
...
Set(Icon(a), 
	RegisterIcon(IconsDir([Png\Products\circlebrown.png]), [circlebrown]));
AddModel3D(
...
CreateAtom(a, Up(s), [], 1, false);
int023([ArrivalList5], 7168771, 1256);
Set(Icon(a), 
	RegisterIcon(pDir([Media\Images\atoms\source.bmp]), [source]));
SetMaterial(
	RegisterMaterial([Default], 8421504, 8421504, 3289650, 0, 0.100000001490116, 0, false, false, 1, 0), 1, a);
...
SetAtt(3, 1);
SetExprAtt(4, [{.~1|4. The repeat time is ~1000~ seconds.}1000]);
SetAtt(5, 0);
SetAtt(6, 20);
SetExprAtt(7, [0]);
SetAtt(8, 2);
...
int018;
Up;
int014(1, 182, 1, 185, 0);
int014(1, 184, 1, 182, 0);
int014(1, 183, 1, 184, 0);
int014(0, 188, 1, 183, 0);
int014(1, 187, 2, 184, 0);
int014(0, 186, 1, 187, 0);
int006(10, 183, 1, 0, 0);
int006(100, 187, 1, 0, 0);
int006(1000, 187, 2, 0, 0);
